  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-page__bg">
        ...
        <div className="glow-orb" style={{ width:'600px', height:'600px', background:'radial-gradient(circle, rgba(0,245,255,0.12) 0%, transparent 70%)', top:'-100px', right:'-100px' }} />
        <div className="glow-orb" style={{ width:'400px', height:'400px', background:'radial-gradient(circle, rgba(124,58,237,0.15) 0%, transparent 70%)', bottom:'-100px', left:'-100px' }} />
      </div>
      ...
      <div className="auth-page__inner">
        ...
        <div className="auth-page__brand">
          ...
          <h1 className="auth-page__brand-title">Welcome Back,<br /><span>Security Pro</span></h1>
          <p className="auth-page__brand-sub">Continue your journey to becoming a world-class cybersecurity professional.</p>
          <div className="auth-page__stats">
            {['50K+ Students', '200+ Courses', '98% Placement'].map(s => (
              <div key={s} className="auth-page__stat glass-card">{s}</div>
            ))}
          </div>
        </div>
        ...
        <div className="auth-page__form-wrapper">
          <div className="auth-card glass-card">
            ...
            <p className="auth-card__subtitle">Access your learning dashboard</p>
